...
class TestVectorStoreFactory:
    ...
    def test_create_with_override_kwargs(self):
        ...
        class ConfigurableVectorStore(BaseVectorStore):
            ...
            def upsert(self, records: list[dict[str, Any]], trace: Any | None = None, **kwargs: Any) -> None:
                pass

            def query(self, vector: list[float], top_k: int = 10, filters: dict[str, Any] | None = None, trace: Any | None = None, **kwargs: Any) -> list[dict[str, Any]]:
                return []
