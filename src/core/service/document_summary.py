"""Document summary retrieval business service.

Owns vector-store access, document metadata / content extraction and result
...
class GetDocumentSummaryConfig:
    """Configuration for document summary retrieval.
...
class DocumentSummaryService:
    """Business service that retrieves document summaries from the store.
...
def format_document_error(error: Exception) -> str:
